...
echo "<form id='editUserForm_" . $rol['id'] . "' method='post' onsubmit='return validateEditTypeForm(\"" . $rol['id'] . "\")' class='needs-validation' novalidate>";
echo '<input type="hidden" id="editUserTypeId_' . $rol['id'] . '" name="editUserTypeId" value="' . $rol['id'] . '">
                    <div class="form-row">
                        <div class="form-group col">
                            <label for="name">Nombre</label>
                            <input type="text" class="form-control" id="editTypeName_' . $rol['id'] . '" name="editTypeName" required autocomplete="off" minlength="2" value="' . $rol['name'] . '">
