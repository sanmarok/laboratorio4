...
if ($_SESSION['user_type_id'] != 1) {
    echo '<script>denegatedUser()</script>';
    exit(); // Asegúrate de salir después de mostrar el SweetAlert
} else {
...
<div class="card card-primary m-2">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#modalAddUser">
        ...
        <table id="dataTableUsers" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                foreach ($users as $user) {
                    ...
                    if ($user['typeuser'] != 'Supreme Admin') {
